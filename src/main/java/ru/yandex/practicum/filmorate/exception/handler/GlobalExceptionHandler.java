...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<String> handleValidationAnnotationException(MethodArgumentNotValidException exception) {
        log.warn("handleValidationAnnotationException {}", exception.getMessage());
